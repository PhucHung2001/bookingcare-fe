...
class UserRedux extends Component {
  ...
  handleOnChangeImage = async (event) => {
    ...
    // console.log("hung check data ", data);
    let file = data[0];
    if (file) {
  ...
  handleSaveUser = () => {
    ...
    // console.log("hung check before submit check state", this.state);
  };
  onChangeInput = (event, id) => {
    ...
    this.setState(
      ...
      // },
      // () => {
      //   console.log("hung check input onchange", this.state);
      // }
    );
  };
  checkValidateInput = () => {
  ...
  render() {
    ...
    // console.log("check state hung", this.state);
    // console.log("check genders from redux", genders);
    // console.log("check loading genders from redux", this.props.isLoadingGender);
    return (
